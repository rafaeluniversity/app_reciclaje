"""
Django settings for app_reciclaje project.
...
SECRET_KEY = 'django-insecure-of!f09h8cu^9!(2sw5u*1#u047-2b$qbd8ao$@m+3yhf5^o^l-'
...
MEDIA_URL = '/'
MEDIA_ROOT = BASE_DIR.parent / 'imagenes'  # Ruta a la carpeta de imágenes en el mismo nivel que el proyecto
